 ...
 * It contains the status of the elevators.
 * It contains the requests for the elevators.
 * It contains the status of the elevator system.
 * It is used to generate a log of the building.
 */
public class BuildingReport {
  ...
  /**
   * This method is used to generate a log of the building.
   */
  public void generateLog() {
    String str = "Elevator reports: " + Arrays.toString(this.elevatorReports)
        + " Up requests: " + this.upRequests
        + " Down requests: " + this.downRequests

...
public class Elevator implements ElevatorInterface {
   ...
   * The elevator is initially at the first floor and is not moving.
   *
   ...
   * If the elevator is on the first floor and the door is open return
   * If the elevator is on the first floor and the door is closed
   * then open the door.
   * <p></p>
   * If the elevator is not on the first floor and the door is open
  ...
  private void stepOutOfService() {
    ...
    // at this point we know we are not on the first floor
